...
The script takes one required argument (`url`) and a set of options (`--format`, `--output`, `--help`).
...
* **--help** or **-h** (optional): Shows help information about the script.
...
* **To print to console:**
    ...
    ```
    -f can be used instead of --format.
...
* **To save to a file:**
    ...
    ```
    -f can be used instead of --format and -o can be used instead of --output.  
...
* **To create a backup with a custom filename:**
    ...
    ```
    node scrapeBlogPost.js https://raviswdev.blogspot.com/2025/08/notes-on-webview-chatgpt.html -o my-backup.html
    ```
